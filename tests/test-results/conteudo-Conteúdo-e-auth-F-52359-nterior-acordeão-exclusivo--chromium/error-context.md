...
Call log:
  ...
  - waiting for locator('button[aria-expanded]').first()
    31 × locator resolved to <button type="button" aria-label="Menu" aria-expanded="true" class="cursor-pointer rounded-md p-2 text-neutral-700 hover:text-primary-300 @Desktop:hidden">…</button>
