/**
 * song-controls.data.ts
 * Dados estáticos do painel de controle da cifra (nada inline em componente,
 * conforme a regra de criação de componentes).
 */
...
/** passo de fonte: 8..16, onde 10 = 100% */
...
export const NOTATION_OPTIONS: SegmentOption<NotationMode>[] = [
  ...
  { value: 'numbers', label: 'Números da Escala' },
];
